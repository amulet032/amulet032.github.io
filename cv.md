...
Analytics: Optimisation, Statistical Modelling, Network Analysis  
...
- Conducted network disruption analysis for state highways
- Developed geospatial analytical workflows
